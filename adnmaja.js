...
$(document).ready(function()
{
   ...
   if($("#blogID").attr("blogID")!="6687807101696198057" ) 
   if($("#blogID").attr("blogID")!="433257412149786665" ) 
   if($("#blogID").attr("blogID")!="1913626799127649529" ) 
   if($("#blogID").attr("blogID")!="6617779432025263039" )
   if($("#blogID").attr("blogID")!="7265313121032980355" )
 {
